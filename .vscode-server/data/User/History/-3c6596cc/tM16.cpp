...
char * strcat (const char *source, char *des)
{
 while (*des != '\0')
 {cout << *des;
 des++;}
...
int main(){
    ...
    cout << "String 1 after concatenation: " << strcat (str1, str2) << endl;
    cout << "String 2 after concatenation: " << strcat (str1, str2) << endl;

    cout << "String 1 after copying: " << strcpy (str1, str2) << endl;
    cout << "String 2 after copying: " << strcpy (str1, str2) << endl;
