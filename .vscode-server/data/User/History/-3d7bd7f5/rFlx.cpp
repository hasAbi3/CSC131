...
void computeArea (Dimensions.length, Dimensions.width )
{
    float A =Dimensions.length * Dimensions.width ;
    cout << A << endl;
}
int main()
{
...
cout << "The area of the rectangle is " << computeArea( p.length, p.width ) << endl; 
