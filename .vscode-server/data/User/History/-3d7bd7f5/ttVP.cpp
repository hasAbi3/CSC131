...
float computeArea (Dimensions p, Dimensions q )
{
    float A = box.sizes.length * box.sizes.width ;
    return A;
}
int main()
{
...
cout << "The area of the rectangle is " << computeArea( Dimensions.length, Dimensions.width ) << endl; 
