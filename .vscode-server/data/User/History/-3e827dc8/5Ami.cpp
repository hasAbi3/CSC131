...
// A switch statement determines which item the user has chosen & A do-while loop repeats until the user selects item E from the menu.
// Abisha Ghimire
#include <iostream> 
#include <iomanip>
...
int main(){
// Fill in the code to define an integer variable called number,a floating point variable called cost,and a character variable called beverage
int number; float cost; char beverage;
bool validBeverage;
...
// Fill in the code to read in beveragecin >> beverage;

switch(beverage){
case 'a':case 'A':case 'b':case 'B':case 'c':case 'C':case 'd':case 'D': validBeverage = true; break;
...
case 'c': case 'C': cout << "The total cost is $ " << number * 1.25 << endl; break; 
// Fill in the code to give the case for tea ( $0.75 a cup)
case 'b': case 'B': cout << "The total cost is $ " << number * 0.75 << endl; break; 
// Fill in the code to give the case for cappuccino ($2.50 a cup)
case 'd': case 'D': cout << "The total cost is $ " << number * 2.5 << endl; break; 
case 'e':
