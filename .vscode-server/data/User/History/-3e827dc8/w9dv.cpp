...
// A do-while loop repeats until the user selects item E from the menu.
...
int main()
{
// Fill in the code to define an integer variable called number,a floating point variable called cost,
