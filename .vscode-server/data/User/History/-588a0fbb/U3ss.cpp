...
const double dollars = 1.06 * euros;
const float dollars = 9.73 * pesos;
const float dollars = 124.35 * yen;
...
convertMulti(float dollars, float& euros, float& pesos);
...
convertMulti(float dollars, float& euros, float& pesos, float& yen);

// Fill in the code to output the value of those dollars converted to euros, pesos and yen
cout << "$ " << dollars << " is converted to " << euros << " euros, " << pesos << " pesos and " << yen << " yen."   ;
