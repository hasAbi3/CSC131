...
monthSales[numOfSales] = new float;

if ( // Fill in the condition to determine if memory has been allocated (or eliminate this if construct if your instructor
...
cin >> count;// Fill in code to bring sales into an element of the array
}
