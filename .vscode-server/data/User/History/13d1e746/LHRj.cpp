...
cout << "findArea, radius and area are active here" << endl << endl;
...
cout << "findCircumference, radius and circumference are active here" << endl << endl;
...
cout << "radius, area, PI, circumference, findArea and findCircumference are active here" << endl << endl;
...
cout << "rad and answer are active here"<< endl << endl;
...
cout << "length and distance are active here" << endl << endl;
